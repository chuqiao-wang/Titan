...
public class TicketMasterAPI implements ExternalAPI {
	...
	private static final String API_KEY = "VoLpTw2U6GzwVGPJCUz7owRDFJEaWke3";
	
	@Override
    public List<Item> search(double lat, double lon, String term) { //lat:经度, lon:纬度
	...
	private String urlEncodeHelper(String term) { //将普通的java string转化成合法的url
		try {
	...
	private void queryAPI(double lat, double lon) { //内部测试函数。 function：call search, get jason array and print them and check 
